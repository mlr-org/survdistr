...
// c_interp_density_mat
NumericMatrix c_interp_density_mat(const NumericMatrix& x, const NumericVector& times, const NumericVector& eval_times, const std::string& method);
RcppExport SEXP _survdistr_c_interp_density_mat(SEXP xSEXP, SEXP timesSEXP, SEXP eval_timesSEXP, SEXP methodSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const NumericMatrix& >::type x(xSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(c_interp_density_mat(x, times, eval_times, method));
    return rcpp_result_gen;
END_RCPP
}
// c_interp_hazard_mat
